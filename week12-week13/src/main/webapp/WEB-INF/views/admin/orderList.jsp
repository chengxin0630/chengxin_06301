		...
		<div class="table-responsive col-sm-10">
			<table class="table table-condensed">
				...
				<tr>
					...
					<%
						com.chengxin.model.Order o=(com.chengxin.model.Order)pageContext.findAttribute("o");
						int userId=o.getCustomerId();
						java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
						com.chengxin.dao.UserDao userDao=new com.chengxin.dao.UserDao();
					...
					<td class="cart_total">${o.paymentId}
						<%
							...
							String paymentType=com.chengxin.model.Payment.findByPaymentId(con,n);
						%>
